                ...
                {isLoading ? (
                    ...
                    <div className="flex-1 overflow-y-auto no-scrollbar space-y-8">
                        ...
                        <div className="bg-gray-100/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-[32px] md:rounded-[48px] border border-white/50 dark:border-gray-700 p-8 md:p-16 text-center shadow-inner mt-8">
                            ...
                            <p className="text-sm text-gray-400 max-w-md mx-auto">{"The content moderation engine is being integrated. You'll soon be able to review pending posts and user creativity here."}</p>
                        </div>
                    </div>
